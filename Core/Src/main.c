...
static void MX_SDMMC1_SD_Init(void)
{
  ...
  /* Card negotiation can take tens of seconds for an unready card. Let the
   * lower-priority SD worker initialize it after CAN/acquisition can run. */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, EN_12V_Pin|LED2_Pin|LED1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : EN_12V_Pin LED2_Pin LED1_Pin */
  GPIO_InitStruct.Pin = EN_12V_Pin|LED2_Pin|LED1_Pin;
...
/* USER CODE BEGIN 4 */
extern void mcp3564r_timer_elapsed_callback(TIM_HandleTypeDef *htim);
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  mcp3564r_timer_elapsed_callback(htim);

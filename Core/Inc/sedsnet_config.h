...
#define SEDS_DT_DAQ_LOG_CLOCK ((SedsDataType)139U)

#define SEDS_DT_DAQ_ADC_TEMPERATURE ((SedsDataType)140U)
#define SEDS_DT_DAQ_THERMAL_CALIBRATION ((SedsDataType)141U)

#define SEDS_DT_DAQ_FILTER_CALIBRATION ((SedsDataType)142U)
#define SEDS_DT_DAQ_SAR_VOLTAGES ((SedsDataType)143U)
